...
public class ConfigManager {
    ...
    // IP de la machine hôte (détectée: 192.168.1.74)
    private static final String DEFAULT_IP = "192.168.1.74";
    private static final String DEFAULT_PORT = "8082"; // Port du backend Docker
