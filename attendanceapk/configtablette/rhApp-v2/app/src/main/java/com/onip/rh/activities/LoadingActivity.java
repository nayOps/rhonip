...
import com.onip.rh.services.DataManager;
import com.onip.rh.services.DeviceManager;
...
public class LoadingActivity extends Activity {
    ...
    private com.onip.rh.utils.ConfigManager configManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        configManager = new com.onip.rh.utils.ConfigManager(this);
    ...
    private void loadAllData() {
        dataManager.loadAllData(new DataManager.AllDataCallback() {
            @Override
            public void onSuccess(List<Employee> employees, Map<Integer, Map<String, byte[]>> templates) {
                Log.d(TAG, "✅ Données chargées: " + employees.size() + " employés, " + templates.size() + " avec templates");
                ...
                runOnUiThread(() -> {
                    updateProgress(100, "✅ Application prête !");
                    
                    // Naviguer vers HomeActivity après un court délai
                    new Handler().postDelayed(() -> {
                        navigateToHome();
                    }, 1000);
                });
    ...
    private void showConfigDialog(String error) {
        runOnUiThread(() -> {
            ...
            if (configView != null) {
                ...
                // Message d'erreur
                txtStatus.setText("❌ Erreur de connexion\n\n" + error + "\n\n" +
                ...
                if (btnRetry != null) {
                    btnRetry.setOnClickListener(v -> {
                        ...
                        Log.d(TAG, "✅ Nouvelle configuration: " + ip + ":" + port);
                        
                        // Recréer DataManager avec la nouvelle config
                        dataManager = new DataManager(this);
                        
                        // Masquer le formulaire et relancer
                        configView.setVisibility(android.view.View.GONE);
                        progressBar.setVisibility(android.view.View.VISIBLE);
                        hasConnectionError = false;
                        
                        updateProgress(40, "Chargement des données avec la nouvelle configuration...");
                        loadAllData();
                    });
                }
            } else {
                ...
                txtStatus.setText("❌ Erreur de connexion\n\n" + error + "\n\n" +
                                "Veuillez redémarrer l'application et vérifier l'IP dans les paramètres");
            }
        });
    }
}
