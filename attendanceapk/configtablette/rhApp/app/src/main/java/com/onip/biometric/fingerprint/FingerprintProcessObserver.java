package com.onip.biometric.fingerprint;
...
public class FingerprintProcessObserver implements Observer {
    ...
    public FingerprintProcessObserver(Activity activity, TextView statusTextView, ImageView fingerprintImageView, ProgressBar qualityProgressBar) {
