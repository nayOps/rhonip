...
public class EmployeeData {
    ...
    private Map<String, byte[]> capturedFingerprints = new HashMap<>(); // Templates binaires
    ...
    public Map<String, byte[]> getCapturedFingerprints() { return capturedFingerprints; }
    public void setCapturedFingerprints(Map<String, byte[]> capturedFingerprints) { 
        this.capturedFingerprints = capturedFingerprints != null ? capturedFingerprints : new HashMap<>(); 
    }
