...
import com.onip.enroll.utils.RetryHelper;
...
public class DeviceManager {
    ...
    private static final String USB_ACTION = "com.onip.enroll.USB_ACTION";
    ...
    public void shutdownDevice() {
        if (morphoDevice != null) {
            com.onip.enroll.fingerprint.MorphoCaptureHelper.closeDevice(morphoDevice);
            morphoDevice = null;
            initialized = false;
