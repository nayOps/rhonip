...
/**
 * Application class pour l'application Attendance
 * Stocke les données globales chargées au démarrage
 */
public class EnrollApplication extends Application {
    
    private static final String TAG = "EnrollApplication";
    
    // Instance singleton
    private static EnrollApplication instance;
    ...
    public void onCreate() {
        super.onCreate();
        instance = this;
        Log.d(TAG, "EnrollApplication onCreate() - Application Attendance démarrée");
    }
    
    public static EnrollApplication getInstance() {
        return instance;
    }
