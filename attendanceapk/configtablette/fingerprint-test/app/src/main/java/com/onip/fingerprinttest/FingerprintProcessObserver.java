...
public class FingerprintProcessObserver implements Observer {
    ...
    private FingerprintTestActivity activity;
    private TextView statusTextView;
    private ImageView fingerprintImageView;
    private ProgressBar qualityProgressBar;
    
    public FingerprintProcessObserver(FingerprintTestActivity activity) {
        this.activity = activity;
        this.statusTextView = activity.findViewById(R.id.txt_status);
        this.fingerprintImageView = activity.findViewById(R.id.img_fingerprint);
        this.qualityProgressBar = activity.findViewById(R.id.progress_quality);
    }
    ...
    private void handleCommandMessage(CallbackMessage message) {
        ...
        activity.runOnUiThread(() -> {
            if (statusTextView != null) {
                String commandText = getCommandText((Integer) command);
    ...
    private void handleQualityMessage(CallbackMessage message) {
        ...
        activity.runOnUiThread(() -> {
            if (qualityProgressBar != null) {
                int qualityValue = (Integer) quality;
                qualityProgressBar.setProgress(qualityValue);
            }
            if (statusTextView != null) {
