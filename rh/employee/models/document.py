...
class Document(Base):
    ...
    document = models.FileField(
        verbose_name=_('document'), upload_to=upload_directory_file, blank=True, null=True, default=None
    )
    name = models.CharField(
        verbose_name=_('nom'), max_length=100, blank=True, null=True, default=None
    )
