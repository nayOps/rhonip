...
const STATUS_COLORS: Record<string, string> = {
  ...
  VALIDATING: 'bg-accent-100 text-accent-800',
};
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard
          title="Agents enrôlés"
          value={stats.total_enrolled.toLocaleString()}
          change={stats.enrollments_this_month > 0 ? `+${stats.enrollments_this_month} ce mois` : 'Aucun enrôlement ce mois'}
        ...
        <StatCard
          ...
          change={stats.enrollments_today > 0 ? 'En progression' : 'Aucun enrôlement'}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow-soft p-6">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-lg font-semibold text-gray-900">Sessions par statut</h3>
        ...
        <div className="bg-white rounded-lg shadow-soft p-6">
          ...
          {Object.keys(byProvince).length > 0 ? (
            ...
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm mt-2">Les statistiques apparaîtront après les premiers enrôlements</p>
            </div>
          )}
        </div>
      </div>
      ...
      {recentSessions.length > 0 && (
        <div className="bg-white rounded-lg shadow-soft p-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Dernières sessions</h3>
              ...
              <tbody>
                {recentSessions.map((session) => (
                  <tr key={session.session_id} className="border-b border-gray-50 last:border-0">
                    ...
                    <td className="py-3 pr-4">
                      <span className={`inline-flex px-2 py-0.5 rounded text-xs font-medium ${STATUS_COLORS[session.status] || 'bg-gray-100 text-gray-800'}`}>
      ...
      <div className="bg-gradient-to-r from-secondary-50 to-primary-50 rounded-lg shadow-soft p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <div className="text-secondary-600 font-semibold mb-1">Nouvel enrôlement</div>
            <div className="text-sm text-gray-600">Enregistrer un agent ONIP</div>
          </Link>
          ...
          <Link
            ...
            className="block p-4 bg-white rounded-lg hover:shadow-md transition-shadow text-center"
          >
            <div className="text-secondary-600 font-semibold mb-1">Liste enrôlements</div>
            <div className="text-sm text-gray-600">Sessions et fiches agents</div>
          </Link>
          ...
          <Link
            ...
            className="block p-4 bg-white rounded-lg hover:shadow-md transition-shadow text-center"
          >
            <div className="text-secondary-600 font-semibold mb-1">Agents RH</div>
            <div className="text-sm text-gray-600">Rechercher par matricule</div>
          </Link>
        </div>
      </div>
    </div>
